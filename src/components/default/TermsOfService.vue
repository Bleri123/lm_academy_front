...
<template>
  <div class="py-10">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          <a href="http:%5Clm_academy.edu" rel="external nofollow noopener" target="_blank"
            >http:\lm_academy.edu</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: bleonnasufi9@gmail.com</li>
    </ul>
  </div>
</template>
...
<style scoped>
h1 {
  @apply text-2xl font-bold space-y-4;
}
h2 {
  @apply text-xl font-bold space-y-3;
}
h3 {
  @apply text-lg font-bold space-y-2;
}
p {
